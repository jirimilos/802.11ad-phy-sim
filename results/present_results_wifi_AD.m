...
fig1 = figure(1);
% BER figure:
%               varianta 1 - BER curves colored according to used modulation mapping
%               varianta 2 - BER curves colored according to used MCS
varianta = 1;
ii = 1;
for i = 1:m
    load(filenames{i});
    switch varianta
        case 1 % according to mapping
            % colors and tags
            if i >= 1 && i < 6 % BPSK
                znacka = '^';
            ...
            if ((i == 2) || (i == 6) || (i == 11) || (i == 16) && (m == 19))
                ...
                h1(ii, 1) = semilogy(-100, 0.5,'-','LineWidth',1.3,'Color',barva); % drawing legend
                ii = ii +1;
